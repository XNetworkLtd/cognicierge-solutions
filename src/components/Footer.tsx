...
export default function Footer() {
  return (
    <footer className="relative bg-[#080E1E] border-t border-blue-900/40 text-slate-400 text-sm overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="pt-2 flex items-center gap-2 text-xs font-mono-tech text-slate-300">
          ...
          <div className="space-y-3">
            <h4 className="font-mono-tech text-xs uppercase tracking-widest text-slate-200 font-bold border-b border-blue-900/50 pb-2">
              TECHNOLOGY DOMAINS
            </h4>
          ...
          <div className="space-y-3">
            <h4 className="font-mono-tech text-xs uppercase tracking-widest text-slate-200 font-bold border-b border-blue-900/50 pb-2 flex items-center gap-2">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-blue-950/80 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono-tech text-slate-400">
          <div>
            &copy; {new Date().getFullYear()} COGNICIERGE SOLUTIONS. ALL RIGHTS RESERVED.
          </div>
